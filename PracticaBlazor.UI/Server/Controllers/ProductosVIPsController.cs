...
namespace PracticaBlazor.UI.Server.Controllers
{
    ...
    public class ProductosVIPsController : ControllerBase
    {
        ...
        {
            List<ProductoVIPs> productosAdmitidos = await _context.ProductoVIPs.Where(u => u.Estado == "ADMITIDOS").ToListAsync();
        ...
        {
            List<ProductoVIPs> productosDenegados = await _context.ProductoVIPs.Where(u => u.Estado == "DENEGADOS").ToListAsync();
